    ...
    <>
      ...
      <ScrollView>
        ...
        <View className="relative">
          ...
          />
          <TouchableOpacity onPress={navigaton.goBack} className="absolute top-14 left-5 p-2 bg-gray-300 rounded-full">
          ...
          <View className="px-4 pt-4">
            ...
            <View className="flex-row space-x-2 my-1">
              <View className="flex-row items-center space-x-1">
                ...
                <Text className="text-xs" color="text-gray-500">
              ...
              <View className="flex-row items-center space-x-1">
                ...
                <Text className="text-xs" color="text-gray-500">Nearby . {address}
                </Text>
              </View>
            </View>
